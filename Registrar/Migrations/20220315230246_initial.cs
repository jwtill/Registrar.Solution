    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentDepartment", x => x.StudentDepartmentId);
                    table.ForeignKey(
                        name: "FK_StudentDepartment_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentDepartment_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentDepartment_DepartmentId",
                table: "StudentDepartment",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentDepartment_StudentId",
                table: "StudentDepartment",
                column: "StudentId");
        }
